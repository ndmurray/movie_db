...
API_TITLE = 'Movie_DB API'
API_DESC = 'A web API for creating, modifying and deleting items from Movie DB'
...
router = SimpleRouter()
router.register(r'titles', TitleViewSet, base_name='titles')
